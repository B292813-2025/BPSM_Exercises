...
with open('all.fasta',"w") as out:
 out.write(">AJ223353.1 Homo sapiens mRNA for histone H2B, clone pJG4-5-15\n")
 for i in range(0,len(no_tab)-window_size+1,offset):
  ...
  out.write(f"Window {i+1}-{i+window_size}: {window_seq} with GC% {percentage}\n")
